...
class BetterERC20Tests: XCTestCase {
    ...
    override func setUp() {
        Chain3.default.options.from = "0x6394b37Cf80A7358b38068f0CA4760ad49983a1B"
    }
    override func tearDown() {
        Chain3.default.options.from = nil
    }
    func testERC20EncodeUsingABIv2() throws {
        ...
        let success = try Chain3DataResponse(response).bool()
    ...
    func testERC20BalanceResponse() throws {
        ...
        let transaction = MOACTransaction(to: contract, data: arguments.data(function: "balanceOf(address)"), options: options)
    ...
    func testERC20NameResponse() throws {
        ...
        let name = try Chain3DataResponse(response).string()
